    ...
    <form className="partner-form partner-apply-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="partner-apply-field">
        ...
        <select
          ...
          onChange={(event) => handleValueChange("namePrefix", event.target.value)}
          onBlur={() => handleFieldBlur("namePrefix")}
          aria-invalid={errors.namePrefix || undefined}
          aria-describedby={errors.namePrefix ? "namePrefix-error" : undefined}
          required
        >
        ...
        {errors.namePrefix ? (
          <p id="namePrefix-error" className="partner-auth-error" role="alert">
